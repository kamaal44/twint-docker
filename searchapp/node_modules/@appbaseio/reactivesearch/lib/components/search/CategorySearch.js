   ...
   * */
	...
	_createClass(CategorySearch, [{
		...
		get: function get() {
			...
			return (0, _utils.withClickIds)(finalSuggestionsList);
		}
	}]);
...
CategorySearch.contextType = _utils.ReactReduxContext;
...
var _initialiseProps = function _initialiseProps() {
	...
	this.renderIcons = function () {
		return _react2.default.createElement(
			...
			_this4.props.showVoiceSearch && _react2.default.createElement(_Mic2.default, {
				getInstance: _this4.props.getMicInstance,
				render: _this4.props.renderMic,
				iconPosition: _this4.props.iconPosition,
				onResult: _this4.handleVoiceResults,
				className: (0, _helper.getClassName)(_this4.props.innerClass, 'mic') || null
			}),
			_react2.default.createElement(
				_InputIcon2.default,
	...
	this.renderNoSuggestion = function () {
		...
		var _props6 = _this4.props,
		    ...
		    renderNoSuggestion = _props6.renderNoSuggestion,
	...
	this.triggerClickAnalytics = function (searchPosition) {
		...
		var _props10 = _this4.props,
		    config = _props10.config,
		    searchId = _props10.analytics.searchId,
		    headers = _props10.headers;
		var url = config.url,
		    app = config.app,
		    credentials = config.credentials;

		var searchState = _this4.context && _this4.context.store ? (0, _helper.getSearchState)(_this4.context.store.getState(), true) : null;
