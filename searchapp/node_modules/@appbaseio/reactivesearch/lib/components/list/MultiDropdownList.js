...
var MultiDropdownList = function (_Component) {
	...
	MultiDropdownList.prototype.componentDidUpdate = function componentDidUpdate(prevProps) {
		...
		(0, _helper.checkSomePropChange)(this.props, prevProps, (0, _utils2.getValidPropsKeys)(this.props), function () {
...
var _initialiseProps = function _initialiseProps() {
	...
	this.handleChange = function (e) {
		...
		if (value === undefined) {
			...
			onChange((0, _utils2.parseValueArray)(_this3.props.value, currentValue));
		}
	};
