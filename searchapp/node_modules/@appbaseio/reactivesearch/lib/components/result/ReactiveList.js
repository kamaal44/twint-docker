...
var ReactiveList = function (_Component) {
	...
	ReactiveList.prototype.componentDidUpdate = function componentDidUpdate(prevProps) {
		...
		if (this.props.onData) {
			(0, _helper.checkSomePropChange)(this.props, prevProps, ['hits', 'streamHits', 'promotedResults', 'total', 'size', 'time'], function () {
	...
	ReactiveList.prototype.render = function render() {
		...
		return _react2.default.createElement(
			...
			this.props.pagination && ['top', 'both'].indexOf(this.props.paginationAt) !== -1 ? paginationElement : null,
			...
			: null,
			this.props.pagination && ['bottom', 'both'].indexOf(this.props.paginationAt) !== -1 ? paginationElement : null,
...
ReactiveList.contextType = _utils.ReactReduxContext;
...
var _initialiseProps = function _initialiseProps() {
	...
	this.renderResultStats = function () {
		if (_this3.props.renderResultStats && _this3.props.total) {
	...
	this.triggerClickAnalytics = function (searchPosition) {
		...
		var _props5 = _this3.props,
		    ...
		    searchId = _props5.analytics.searchId,
		    headers = _props5.headers;
		var url = config.url,
		    app = config.app,
		    credentials = config.credentials;

		var searchState = _this3.context && _this3.context.store ? (0, _helper.getSearchState)(_this3.context.store.getState(), true) : null;
