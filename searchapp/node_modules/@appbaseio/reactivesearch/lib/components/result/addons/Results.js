...
var Results = function (_React$Component) {
	...
	Results.prototype.shouldComponentUpdate = function shouldComponentUpdate(nextProps) {
		/*
  ...
  */
		...
		return !(0, _helper.isEqual)(nextProps.filteredResults, this.props.filteredResults);
	};
