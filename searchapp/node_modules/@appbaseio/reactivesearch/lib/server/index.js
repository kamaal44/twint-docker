...
var componentsWithOptions = ['ReactiveList', 'ReactiveMap', 'SingleList', 'MultiList', 'TagCloud'].concat(componentsWithHighlightQuery);

var componentsWithoutFilters = ['NumberBox', 'RatingsFilter'];

var resultComponents = ['ReactiveList', 'ReactiveMap'];
...
function initReactivesearch(componentCollection, searchState, settings) {
	return new Promise(function (resolve, reject) {
		...
		var requestQuery = config.transformRequest ? config.transformRequest(finalQuery) : finalQuery;
