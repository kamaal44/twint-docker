...
var series = npsUtils.series,
    concurrent = npsUtils.concurrent,
    rimraf = npsUtils.rimraf,
    crossEnv = npsUtils.crossEnv;
...
module.exports = {
  scripts: {
    ...
    build: {
      ...
      default: series(rimraf('dist'), concurrent.nps('compileToes5', 'build.es', 'build.cjs', 'build.umd.main', 'build.umd.min')),
      es: {
