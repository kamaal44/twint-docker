...
var WebSocket = function (_EventEmitter) {
  ...
  function WebSocket(address, protocols, options) {
    ...
    if (address !== null) {
      ...
      } else if ((typeof protocols === 'undefined' ? 'undefined' : _typeof(protocols)) === 'object' && protocols !== null) {
        options = protocols;
        protocols = undefined;
      }
...
function initAsClient(address, protocols, options) {
  ...
  if ((typeof address === 'undefined' ? 'undefined' : _typeof(address)) === 'object' && address.href !== undefined) {
    parsedUrl = address;
  ...
  if (options.handshakeTimeout) {
    req.setTimeout(options.handshakeTimeout, function () {
      return abortHandshake(_this3, req, 'Opening handshake has timed out');
    });
  }
  ...
  req.on('upgrade', function (res, socket, head) {
    ...
    _this3.setSocket(socket, head, 0);
  });
}
