...
module.exports = function (assign, t) {
	...
	t.test('non-object target, no sources', function (st) {
		...
		st.equal(typeof bool === 'undefined' ? 'undefined' : _typeof(bool), 'object', 'bool is object');
		st.equal(Boolean.prototype.valueOf.call(bool), true, 'bool coerces to `true`');

		var number = assign(1);
		st.equal(typeof number === 'undefined' ? 'undefined' : _typeof(number), 'object', 'number is object');
		st.equal(Number.prototype.valueOf.call(number), 1, 'number coerces to `1`');

		var string = assign('1');
		st.equal(typeof string === 'undefined' ? 'undefined' : _typeof(string), 'object', 'number is object');
	...
	t.test('non-object target, with sources', function (st) {
		...
		st.test('boolean', function (st2) {
			...
			st2.equal(typeof bool === 'undefined' ? 'undefined' : _typeof(bool), 'object', 'bool is object');
			st.equal(Boolean.prototype.valueOf.call(bool), true, 'bool coerces to `true`');
		...
		st.test('number', function (st2) {
			...
			st2.equal(typeof number === 'undefined' ? 'undefined' : _typeof(number), 'object', 'number is object');
		...
		st.test('string', function (st2) {
			...
			st2.equal(typeof string === 'undefined' ? 'undefined' : _typeof(string), 'object', 'number is object');
	...
	t.test('includes enumerable symbols, after keys', { skip: !hasSymbols }, function (st) {
		var visited = [];
		var obj = {};
		Object.defineProperty(obj, 'a', { enumerable: true, get: function get() {
				visited.push('a');return 42;
			} });
		var symbol = Symbol('enumerable');
		Object.defineProperty(obj, symbol, {
			enumerable: true,
			get: function get() {
				visited.push(symbol);return Infinity;
			}
		});
		...
		Object.defineProperty(obj, nonEnumSymbol, {
			enumerable: false,
			get: function get() {
				visited.push(nonEnumSymbol);return -Infinity;
			}
		});
