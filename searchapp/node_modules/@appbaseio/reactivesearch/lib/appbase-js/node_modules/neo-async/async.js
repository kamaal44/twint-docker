...
(function (global, factory) {
  ...
  (typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) : typeof define === 'function' && define.amd ? define(['exports'], factory) : global.async ? factory(global.neo_async = global.neo_async || {}) : factory(global.async = global.async || {});
  ...
  var iteratorSymbol = (typeof Symbol === 'undefined' ? 'undefined' : _typeof(Symbol)) === func && Symbol.iterator;
  ...
  function createImmediate(safeMode) {
    ...
    asyncSetImmediate = (typeof setImmediate === 'undefined' ? 'undefined' : _typeof(setImmediate)) === func ? setImmediate : delay;
    if ((typeof process === 'undefined' ? 'undefined' : _typeof(process)) === obj && _typeof(process.nextTick) === func) {
  ...
  function createEach(arrayEach, baseEach, symbolEach) {
    return function each(collection, iterator, callback) {
      ...
      } else if ((typeof collection === 'undefined' ? 'undefined' : _typeof(collection)) === obj) {
  ...
  function createParallel(arrayEach, baseEach) {
    return function parallel(tasks, callback) {
      ...
      } else if (tasks && (typeof tasks === 'undefined' ? 'undefined' : _typeof(tasks)) === obj) {
  ...
  function priorityQueue(worker, concurrency) {
    ...
    function push(tasks, priority, callback) {
      ...
      callback = (typeof callback === 'undefined' ? 'undefined' : _typeof(callback)) === func ? callback : noop;
  ...
  function auto(tasks, concurrency, callback) {
    if ((typeof concurrency === 'undefined' ? 'undefined' : _typeof(concurrency)) === func) {
  ...
  function retry(opts, task, callback) {
    ...
    var count = 0;
    if (arguments.length < 3 && (typeof opts === 'undefined' ? 'undefined' : _typeof(opts)) === func) {
      callback = task || noop;
      task = opts;
      opts = null;
      times = DEFAULT_TIMES;
      ...
      callback = callback || noop;
      switch (typeof opts === 'undefined' ? 'undefined' : _typeof(opts)) {
        case 'object':
          if (_typeof(opts.errorFilter) === func) {
            errorFilter = opts.errorFilter;
          }
          var interval = opts.interval;
          switch (typeof interval === 'undefined' ? 'undefined' : _typeof(interval)) {
            case func:
  ...
  function createLogger(name) {
    ...
    function done(err) {
      if ((typeof console === 'undefined' ? 'undefined' : _typeof(console)) === obj) {
        if (err) {
          if (console.error) {
            console.error(err);
          }
