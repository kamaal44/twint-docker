...
!function (a) {
  ...
  return function s(m, t, u) {
    function r(o, a) {
      if (!t[o]) {
        if (!m[o]) {
          var i = "function" == typeof require && require;if (!a && i) return i(o, !0);if (p) return p(o, !0);var e = new Error("Cannot find module '" + o + "'");throw e.code = "MODULE_NOT_FOUND", e;
        }var n = t[o] = { exports: {} };m[o][0].call(n.exports, function (a) {
          return r(m[o][1][a] || a);
        }, n, n.exports, s, m, t, u);
      }return t[o].exports;
      ...
      "use strict";
      var p = a("punycode"),
          k = {};k.rules = a("./data/rules.json").map(function (a) {
        ...
        var i = p.toASCII(a);return k.rules.reduce(function (a, o) {
          return -1 === o.punySuffix && (o.punySuffix = p.toASCII(o.suffix)), k.endsWith(i, "." + o.punySuffix) || i === o.punySuffix ? o : a;
        }, null);
      }, r.errorCodes = { DOMAIN_TOO_SHORT: "Domain name too short.", DOMAIN_TOO_LONG: "Domain name too long. It should be no more than 255 chars.", LABEL_STARTS_WITH_DASH: "Domain name label can not start with a dash.", LABEL_ENDS_WITH_DASH: "Domain name label can not end with a dash.", LABEL_TOO_LONG: "Domain name label should be at most 63 chars long.", LABEL_TOO_SHORT: "Domain name label should be at least 1 character long.", LABEL_INVALID_CHARS: "Domain name label can only contain alphanumeric characters or dashes." }, k.validate = function (a) {
        var o = p.toASCII(a);if (o.length < 1) return "DOMAIN_TOO_SHORT";if (255 < o.length) return "DOMAIN_TOO_LONG";for (var i, e = o.split("."), n = 0; n < e.length; ++n) {
          if (!(i = e[n]).length) return "LABEL_TOO_SHORT";if (63 < i.length) return "LABEL_TOO_LONG";if ("-" === i.charAt(0)) return "LABEL_STARTS_WITH_DASH";if ("-" === i.charAt(i.length - 1)) return "LABEL_ENDS_WITH_DASH";if (!/^[a-z0-9\-]+$/.test(i)) return "LABEL_INVALID_CHARS";
        }
      }, r.parse = function (a) {
        if ("string" != typeof a) throw new TypeError("Domain name must be a string.");var o = a.slice(0).toLowerCase();"." === o.charAt(o.length - 1) && (o = o.slice(0, o.length - 1));var i = k.validate(o);if (i) return { input: a, error: { message: r.errorCodes[i], code: i } };var e = { input: a, tld: null, sld: null, domain: null, subdomain: null, listed: !1 },
            n = o.split(".");if ("local" === n[n.length - 1]) return e;var s = function s() {
          return (/xn--/.test(o) && (e.domain && (e.domain = p.toASCII(e.domain)), e.subdomain && (e.subdomain = p.toASCII(e.subdomain))), e
          );
        },
            m = k.findRule(o);if (!m) return n.length < 2 ? e : (e.tld = n.pop(), e.sld = n.pop(), e.domain = [e.sld, e.tld].join("."), n.length && (e.subdomain = n.pop()), s());e.listed = !0;var t = m.suffix.split("."),
            u = n.slice(0, n.length - t.length);return m.exception && u.push(t.shift()), e.tld = t.join("."), u.length ? (m.wildcard && (t.unshift(u.pop()), e.tld = t.join(".")), u.length && (e.sld = u.pop(), e.domain = [e.sld, e.tld].join("."), u.length && (e.subdomain = u.join("."))), s()) : s();
      }, r.get = function (a) {
        return a && r.parse(a).domain || null;
      }, r.isValid = function (a) {
        var o = r.parse(a);return Boolean(o.domain && o.listed);
      };
    }, { "./data/rules.json": 1, punycode: 3 }], 3: [function (a, T, D) {
      (function (S) {
        !function (a) {
          var o = "object" == (typeof D === "undefined" ? "undefined" : _typeof(D)) && D && !D.nodeType && D,
              i = "object" == (typeof T === "undefined" ? "undefined" : _typeof(T)) && T && !T.nodeType && T,
              e = "object" == (typeof S === "undefined" ? "undefined" : _typeof(S)) && S;e.global !== e && e.window !== e && e.self !== e || (a = e);var n,
              s,
              d = 2147483647,
              b = 36,
              y = 1,
              ...
              c = b - y,
              x = Math.floor,
              q = String.fromCharCode;function A(a) {
            ...
            var i = a.split("@"),
                e = "";return 1 < i.length && (e = i[0] + "@", a = i[1]), e + g((a = a.replace(p, ".")).split("."), o).join(".");
          }function O(a) {
            ...
            return g(a, function (a) {
              var o = "";return 65535 < a && (o += q((a -= 65536) >>> 10 & 1023 | 55296), a = 56320 | 1023 & a), o += q(a);
            }).join("");
          }function L(a, o) {
            return a + 22 + 75 * (a < 26) - ((0 != o) << 5);
          }function I(a, o, i) {
            var e = 0;for (a = i ? x(a / t) : a >> 1, a += x(a / o); c * f >> 1 < a; e += b) {
              a = x(a / c);
            ...
            var o,
                ...
                l = 0,
                h = w,
                j = v;for ((i = a.lastIndexOf(z)) < 0 && (i = 0), e = 0; e < i; ++e) {
              128 <= a.charCodeAt(e) && A("not-basic"), c.push(a.charCodeAt(e));
            }for (n = 0 < i ? i + 1 : 0; n < g;) {
              for (s = l, m = 1, t = b; g <= n && A("invalid-input"), k = a.charCodeAt(n++), (b <= (u = k - 48 < 10 ? k - 22 : k - 65 < 26 ? k - 65 : k - 97 < 26 ? k - 97 : b) || u > x((d - l) / m)) && A("overflow"), l += u * m, !(u < (r = t <= j ? y : j + f <= t ? f : t - j)); t += b) {
                m > x(d / (p = b - r)) && A("overflow"), m *= p;
              }j = I(l - s, o = c.length + 1, 0 == s), x(l / o) > d - h && A("overflow"), h += x(l / o), l %= o, c.splice(l++, 0, h);
            }return _(c);
          }function j(a) {
            var o,
                i,
                ...
                l,
                h,
                j = [];for (c = (a = O(a)).length, o = w, s = v, m = i = 0; m < c; ++m) {
              (k = a[m]) < 128 && j.push(q(k));
            }for (e = n = j.length, n && j.push(z); e < c;) {
              for (t = d, m = 0; m < c; ++m) {
                o <= (k = a[m]) && k < t && (t = k);
              }for (t - o > x((d - i) / (g = e + 1)) && A("overflow"), i += (t - o) * g, o = t, m = 0; m < c; ++m) {
                if ((k = a[m]) < o && ++i > d && A("overflow"), k == o) {
                  for (u = i, r = b; !(u < (p = r <= s ? y : s + f <= r ? f : r - s)); r += b) {
                    h = u - p, l = b - p, j.push(q(L(p + h % l, 0))), u = x(h / l);
                  }j.push(q(L(u, 0))), s = I(i, g, e == n), i = 0, ++e;
                }
              }++i, ++o;
            }return j.join("");
          }if (n = { version: "1.4.1", ucs2: { decode: O, encode: _ }, decode: h, encode: j, toASCII: function toASCII(a) {
