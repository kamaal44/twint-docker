          ...
          if (h.test(String(e.key))) {
            ...
            var context = {
              add: function add(ch, db) {
                ...
                var prefix = getPrefix(ch.prefix) || getPrefix(db) || h.prefix || '';
              ...
              put: function put(ch, db) {
                if ('object' === (typeof ch === 'undefined' ? 'undefined' : _typeof(ch))) ch.type = 'put';
                return this.add(ch, db);
              },
              del: function del(ch, db) {
                if ('object' === (typeof ch === 'undefined' ? 'undefined' : _typeof(ch))) ch.type = 'del';
                return this.add(ch, db);
              },
              veto: function veto() {
