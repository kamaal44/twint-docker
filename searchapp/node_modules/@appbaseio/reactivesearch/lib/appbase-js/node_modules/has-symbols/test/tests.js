 ...
 */
	...
	t.equal(_typeof(Symbol.prototype.toString), 'function', 'Symbol#toString is a function');
	...
	t.notEqual(typeof sym === 'undefined' ? 'undefined' : _typeof(sym), 'string', 'Symbol is not a string');
