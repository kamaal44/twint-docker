...
buster.testCase('approximateSize()', {
  ...
  'approximateSize() works on empty database': function approximateSizeWorksOnEmptyDatabase(done) {
  ...
  'approximateSize() work on none-empty database': function approximateSizeWorkOnNoneEmptyDatabase(done) {
