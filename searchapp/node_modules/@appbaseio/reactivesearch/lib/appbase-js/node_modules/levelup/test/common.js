...
referee.add('isInstanceOf', {
  ...
  refute: function refute(actual, expected) {
    return !(actual instanceof expected);
  },
...
module.exports.openTestDatabase = function () {
  var options = _typeof(arguments[0]) == 'object' ? arguments[0] : { createIfMissing: true, errorIfExists: true },
