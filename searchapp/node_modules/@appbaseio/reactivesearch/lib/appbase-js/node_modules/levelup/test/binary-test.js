...
buster.testCase('Binary API', {
  ...
  'sanity check on test data': function sanityCheckOnTestData(done) {
    assert(Buffer.isBuffer(this.testData));
    common.checkBinaryTestData(this.testData, done);
  },

  'test put() and get() with binary value {encoding:binary}': function testPutAndGetWithBinaryValueEncodingBinary(done) {
  ...
  'test put() and get() with binary value {encoding:binary} on createDatabase()': function testPutAndGetWithBinaryValueEncodingBinaryOnCreateDatabase(done) {
  ...
  'test put() and get() with binary key {encoding:binary}': function testPutAndGetWithBinaryKeyEncodingBinary(done) {
    this.openTestDatabase(function (db) {
  ...
  'test put() and get() with binary value {keyEncoding:utf8,valueEncoding:binary}': function testPutAndGetWithBinaryValueKeyEncodingUtf8ValueEncodingBinary(done) {
    this.openTestDatabase(function (db) {
  ...
  'test put() and get() with binary value {keyEncoding:utf8,valueEncoding:binary} on createDatabase()': function testPutAndGetWithBinaryValueKeyEncodingUtf8ValueEncodingBinaryOnCreateDatabase(done) {
  ...
  'test put() and get() with binary key {keyEncoding:binary,valueEncoding:utf8}': function testPutAndGetWithBinaryKeyKeyEncodingBinaryValueEncodingUtf8(done) {
    this.openTestDatabase(function (db) {
  ...
  'test put() and get() with binary key & value {encoding:binary}': function testPutAndGetWithBinaryKeyValueEncodingBinary(done) {
    this.openTestDatabase(function (db) {
  ...
  'test put() and del() and get() with binary key {encoding:binary}': function testPutAndDelAndGetWithBinaryKeyEncodingBinary(done) {
    this.openTestDatabase(function (db) {
      db.put(this.testData, 'binarydata', { encoding: 'binary' }, function (err) {
        refute(err);
  ...
  'batch() with multiple puts': function batchWithMultiplePuts(done) {
    this.openTestDatabase(function (db) {
      db.batch([{ type: 'put', key: 'foo', value: this.testData }, { type: 'put', key: 'bar', value: this.testData }, { type: 'put', key: 'baz', value: 'abazvalue' }], { keyEncoding: 'utf8', valueEncoding: 'binary' }, function (err) {
        refute(err);
