...
var Readable = require('readable-stream').Readable,
    ...
    makeKeyValueData = function makeKeyValueData(key, value) {
  return {
    key: util.decodeKey(key, this._options),
    value: util.decodeValue(value, this._options)
  };
},
    makeKeyData = function makeKeyData(key) {
  return util.decodeKey(key, this._options);
},
    makeValueData = function makeValueData(_, value) {
  return util.decodeValue(value, this._options);
},
    makeNoData = function makeNoData() {
  return null;
};
