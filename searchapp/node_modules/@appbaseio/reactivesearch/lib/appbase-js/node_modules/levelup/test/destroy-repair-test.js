...
buster.testCase('Destroy & Repair', {
  'destroy() is alias for leveldown.destroy()': function destroyIsAliasForLeveldownDestroy() {
  ...
  'repair() is alias for leveldown.repair()': function repairIsAliasForLeveldownRepair() {
    var ldmock = this.mock(leveldown),
  ...
  'destroy() passes on arguments': function destroyPassesOnArguments() {
    var ldmock = this.mock(leveldown),
  ...
  'repair() passes on arguments': function repairPassesOnArguments() {
    var ldmock = this.mock(leveldown),
        args = ['location', function () {}],
  ...
  'destroy() substitutes missing callback argument': function destroySubstitutesMissingCallbackArgument() {
    var ldmock = this.mock(leveldown),
        args = ['location'],
  ...
  'repair() substitutes missing callback argument': function repairSubstitutesMissingCallbackArgument() {
    var ldmock = this.mock(leveldown),
        args = ['location'],
