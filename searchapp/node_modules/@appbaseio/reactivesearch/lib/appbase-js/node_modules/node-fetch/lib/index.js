	...
	try {
		for (var _iterator7 = Object.keys(obj)[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
			...
			if (Array.isArray(obj[name])) {
				...
				try {
					for (var _iterator8 = obj[name][Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
...
function isRequest(input) {
	return (typeof input === 'undefined' ? 'undefined' : _typeof(input)) === 'object' && _typeof(input[INTERNALS$2]) === 'object';
}
