...
Object.defineProperties(module.exports, {
  ...
  isMaster: { enumerable: true, get: function get() {
      return cluster.isMaster;
    }, set: function set(v) {
      cluster.isMaster = v;
    } },
  isWorker: { enumerable: true, get: function get() {
      return cluster.isWorker;
    }, set: function set(v) {
      cluster.isWorker = v;
    } },
  schedulingPolicy: { enumerable: true, get: function get() {
      return cluster.schedulingPolicy;
    }, set: function set(v) {
      cluster.schedulingPolicy = v;
    } },
  settings: { enumerable: true, get: function get() {
      return cluster.settings;
    }, set: function set(v) {
      cluster.settings = v;
    } },
  setupMaster: { enumerable: true, value: bind(cluster, cluster.setupMaster) },
  workers: { enumerable: true, get: function get() {
