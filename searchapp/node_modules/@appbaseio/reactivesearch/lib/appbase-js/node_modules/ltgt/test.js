...
{ range: { start: 2 },
  selection: [2, 3, 4, 5]
}, { range: { start: 2, reverse: true },
  selection: [2, 1]
}, { range: { end: 2 },
  selection: [1, 2]
}, { range: { end: 2, reverse: true },
  selection: [2, 3, 4, 5].reverse()
}, { range: { start: 2.5 },
  selection: [3, 4, 5]
}, { range: { start: 2.5, reverse: true },
  selection: [2, 1]
}, { range: { end: 2.5, reverse: true },
  selection: [5, 4, 3]
}, { range: { start: 5 },
  selection: [5]
}, { range: { start: 5.5 },
  ...
  selection: []
}, { range: { start: 5.5, reverse: true },
  selection: [5, 4, 3, 2, 1]
}, { range: { end: 0.5, reverse: true },
  selection: [5, 4, 3, 2, 1]
},

//nullish and empty strings signify are streated like null!
{ range: { end: null, reverse: true },
  selection: [5, 4, 3, 2, 1]
}, { range: { end: undefined, reverse: true },
  selection: [5, 4, 3, 2, 1]
}, { range: { end: '', reverse: true },
  selection: [5, 4, 3, 2, 1]
},
...
var sranges = [{ range: { start: '00' },
  selection: ['00', '01', '02']
}, { range: { start: '03', reverse: true },
  selection: ['02', '01', '00']
}];
...
make(elements.map(String), ranges.map(function (e) {
  ...
  for (var k in e.range) {
    if ('number' === typeof e.range[k]) r[k] = e.range.toString();
...
function make(elements, ranges) {
  ...
  ranges.forEach(function (e) {
    ...
    tape(JSON.stringify(e.range) + ' => ' + JSON.stringify(e.selection), function (t) {
      ...
      if (e.range.reverse) actual.reverse();
      ...
      if (e.range.reverse) actual2.reverse();
...
function createLtgtTests(mutate) {
  return function (t) {
    ...
    T({ gte: 'foo!a', lte: 'foo!b', reverse: true }, { start: 'b', end: 'a', reverse: true });
