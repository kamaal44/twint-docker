...
(function (global, factory) {
  (typeof exports === 'undefined' ? 'undefined' : _typeof2(exports)) === 'object' && typeof module !== 'undefined' ? module.exports = factory() : typeof define === 'function' && define.amd ? define(factory) : global.Appbase = factory();
})(undefined, function () {
  'use strict';
  ...
  function str(key, holder) {
    ...
    if (value && (typeof value === 'undefined' ? 'undefined' : _typeof2(value)) === 'object' && typeof value.toJSON === 'function') {
    ...
    switch (typeof value === 'undefined' ? 'undefined' : _typeof2(value)) {
      ...
      case 'object':
        ...
        // stringified.
        if (rep && (typeof rep === 'undefined' ? 'undefined' : _typeof2(rep)) === 'object') {
          length = rep.length;
          for (i = 0; i < length; i += 1) {
            k = rep[i];
            if (typeof k === 'string') {
  ...
  var stringify = function stringify(value, replacer, space) {
    ...
    rep = replacer;
    if (replacer && typeof replacer !== 'function' && ((typeof replacer === 'undefined' ? 'undefined' : _typeof2(replacer)) !== 'object' || typeof replacer.length !== 'number')) {
  ...
  var jsonStableStringify = function jsonStableStringify(obj, opts) {
    ...
    return function stringify(parent, key, node, level) {
      ...
      if ((typeof node === 'undefined' ? 'undefined' : _typeof2(node)) !== 'object' || node === null) {
