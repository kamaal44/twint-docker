...
var globsToMatcher = function globsToMatcher(globs) {
  ...
  return function (path) {
    return (0, (_micromatch || _load_micromatch()).default)([path], globs, { dot: true }).length > 0;
  };
};
...
var SearchSource = function () {
  ...
  _createClass(SearchSource, [{
    ...
    value: function findRelatedTests(allPaths, collectCoverage) {
      ...
      var collectCoverageFrom = void 0;
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                _ref = _context.sent;
                repos = _ref.repos, changedFiles = _ref.changedFiles;
                // no SCM (git/hg/...) is found in any of the roots.

                noSCM = Object.keys(repos).every(function (scm) {
                  return repos[scm].size === 0;
                });
                return _context.abrupt('return', noSCM ? { noSCM: true, tests: [] } : _this.findRelatedTests(changedFiles, collectCoverage));
