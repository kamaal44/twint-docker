...
var ERROR = (_utils || _load_utils()).BULLET + 'Validation Error';
...
var setupPreset = function setupPreset(options, optionsPreset) {
  ...
  try {
    ...
    if (_preset) {
      throw createConfigError('  Module ' + (_chalk || _load_chalk()).default.bold(presetPath) + ' should have "jest-preset.js" or "jest-preset.json" file at the root.');
    }
