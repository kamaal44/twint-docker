...
var coercibleObject = { valueOf: function valueOf() {
		return '3';
...
var valueOfOnlyObject = { valueOf: function valueOf() {
		return 4;
	}, toString: function toString() {
		return {};
	} };
var toStringOnlyObject = { valueOf: function valueOf() {
		return {};
	}, toString: function toString() {
		return 7;
	} };
var uncoercibleObject = { valueOf: function valueOf() {
		return {};
	}, toString: function toString() {
		return {};
	} };
...
test('ToPrimitive', function (t) {
	...
	t.test('objects', function (st) {
		...
		st['throws'](function () {
			return ES.ToPrimitive(uncoercibleObject);
		}, TypeError, 'uncoercibleObject throws a TypeError');
		st['throws'](function () {
			return ES.ToPrimitive(uncoercibleFnObject);
...
test('ToNumber', function (t) {
	...
	t['throws'](function () {
		return ES.ToNumber(uncoercibleObject);
...
test('ToInteger', function (t) {
	...
	t['throws'](function () {
		return ES.ToInteger(uncoercibleObject);
	}, TypeError, 'uncoercibleObject throws');
	t.end();
});
...
test('ToInt32', function (t) {
	...
	t['throws'](function () {
		return ES.ToInt32(uncoercibleObject);
	}, TypeError, 'uncoercibleObject throws');
...
test('ToUint32', function (t) {
	...
	t['throws'](function () {
		return ES.ToUint32(uncoercibleObject);
	}, TypeError, 'uncoercibleObject throws');
...
test('ToUint16', function (t) {
	...
	t['throws'](function () {
		return ES.ToUint16(uncoercibleObject);
	}, TypeError, 'uncoercibleObject throws');
...
test('ToString', function (t) {
	t['throws'](function () {
		return ES.ToString(uncoercibleObject);
	}, TypeError, 'uncoercibleObject throws');
	t.end();
});
...
test('IsAccessorDescriptor', function (t) {
	forEach(nonNullPrimitives.concat(null), function (primitive) {
		...
		}, TypeError, primitive + ' is not a Property Descriptor');
	});
...
test('ToPropertyDescriptor', function (t) {
	forEach(nonNullPrimitives.concat(null), function (primitive) {
		...
		}, TypeError, primitive + ' is not an Object');
	});
