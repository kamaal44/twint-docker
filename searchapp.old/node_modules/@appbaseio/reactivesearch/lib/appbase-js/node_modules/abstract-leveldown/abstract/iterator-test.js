...
var db,
  ...
  return d;
    ...
    transformSource = function transformSource(d) {
...
module.exports.args = function (test) {
  test('test argument-less iterator#next() throws', function (t) {
    ...
    t.throws(iterator.next.bind(iterator), { name: 'Error', message: 'next() requires a callback argument' }, 'no-arg iterator#next() throws');
  ...
  test('test argument-less iterator#end() after next() throws', function (t) {
    ...
    iterator.next(function () {
      t.throws(iterator.end.bind(iterator), { name: 'Error', message: 'end() requires a callback argument' }, 'no-arg iterator#end() throws');
      iterator.end(t.end.bind(t));
    });
  });
...
module.exports.iterator = function (leveldown, test, testCommon, collectEntries) {
  test('test simple iterator()', function (t) {
    var data = [{ type: 'put', key: 'foobatch1', value: 'bar1' }, { type: 'put', key: 'foobatch2', value: 'bar2' }, { type: 'put', key: 'foobatch3', value: 'bar3' }],
        idx = 0;

    db.batch(data, function (err) {
      t.notOk(err, 'no error');
      var iterator = db.iterator(),
          fn = function fn(err, key, value) {
        t.notOk(err, 'no error');
        if (key && value) {
