...
var cli = {
    ...
    execute: function execute(args, text) {
        ...
        var useStdin = typeof text === "string";
        ...
        if (currentOptions.version) {
            ...
            var engine = new CLIEngine(translateOptions(currentOptions));
            ...
            var _engine = new CLIEngine(translateOptions(currentOptions));
            var report = useStdin ? _engine.executeOnText(text, currentOptions.stdinFilename, true) : _engine.executeOnFiles(files);
