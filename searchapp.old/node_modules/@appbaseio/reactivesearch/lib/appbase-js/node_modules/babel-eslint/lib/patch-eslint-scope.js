...
function monkeypatch(modules) {
  ...
  referencer.prototype.OptionalMemberExpression = referencer.prototype.MemberExpression;
...
module.exports = function (parserOptions) {
  ...
  escope.analyze = function (ast, opts) {
    ...
    opts.nodejsScope = ast.sourceType === "script" && (parserOptions.ecmaFeatures && parserOptions.ecmaFeatures.globalReturn) === true;
