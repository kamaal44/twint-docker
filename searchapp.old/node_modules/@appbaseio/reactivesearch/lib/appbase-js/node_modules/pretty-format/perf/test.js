...
var prettyFormat = require('../build');
var ReactTestComponent = require('../build/plugins/react_test_component');
...
function test(name, value, ignoreResult, prettyFormatOpts) {
  ...
  var inspected = testCase('util.inspect()  ', function () {
    return _util2.default.inspect(value, {
      depth: null,
      showHidden: true
    });
  });
...
var element = React.createElement('div', { onClick: function onClick() {}, prop: { a: 1, b: 2 } }, React.createElement('div', { prop: { a: 1, b: 2 } }), React.createElement('div'), React.createElement('div', { prop: { a: 1, b: 2 } }, React.createElement('div', null, React.createElement('div'))));
