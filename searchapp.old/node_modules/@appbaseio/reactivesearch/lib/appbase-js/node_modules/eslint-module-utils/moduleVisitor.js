...
exports.default = function visitModules(visitor, options) {
  ...
  if (options.ignore != null) {
    ignoreRegExps = options.ignore.map(function (p) {
      return new RegExp(p);
    });
  }
  ...
  function checkAMD(call) {
    ...
    try {
      for (var _iterator = modules.elements[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
