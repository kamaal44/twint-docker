  ...
  _createClass(Runtime, [{
    ...
    value: function resetModules() {
      ...
      if (this._environment && this._environment.global) {
        ...
        Object.keys(envGlobal).forEach(function (key) {
          ...
          if ((typeof globalMock === 'undefined' ? 'undefined' : _typeof(globalMock)) === 'object' && globalMock !== null || typeof globalMock === 'function') {
    ...
    value: function _execModule(localModule, options, moduleRegistry, from) {
      ...
      if (runScript === null) {
        ...
        console.error('\n' + message + '\n' + (0, (_jestMessageUtil || _load_jestMessageUtil()).formatStackTrace)(stack, this._config, { noStackTrace: false }));
        process.exitCode = 1;
        return;
      }
