...
exports.getBin = exports.shellEscape = exports.includePackage = exports.setColors = exports.commonTags = exports.crossEnv = exports.open = exports.mkdirp = exports.ncp = exports.copy = exports.ifNotWindows = exports.ifWindows = exports.rimraf = exports.runInNewWindow = exports.series = exports.concurrent = undefined;
...
function concurrent(scripts) {
  ...
  var concurrently = runBin('concurrently');
...
concurrent.nps = function concurrentNPS() {
  ...
  function mapNPSScripts(scriptName, index) {
    ...
    if (!Boolean(scriptName)) {
      ...
      return { script: scriptName, color: color };
    } else {
      return Object.assign({ color: color }, scriptName);
    }
  }
...
function runInNewWindow(command) {
  return isWindows() ? "start cmd /k \"cd " + process.cwd() + " && " + command + "\"" : commonTags.oneLine(_templateObject, process.cwd(), command);
}
...
function getBin(packageName) {
  ...
  if ((typeof binRelativeToPackage === "undefined" ? "undefined" : _typeof(binRelativeToPackage)) === 'object') {
  ...
  return _path2.default.relative(process.cwd(), fullBinPath);
}

function runBin() {
  return "node " + getBin.apply(undefined, arguments);
}
