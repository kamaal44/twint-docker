...
test('key only stream keys do not include sublevel prefix', function (t) {
  ...
  var arr = [];
  sub.createReadStream({ keys: true, values: false }).pipe(through(arr.push.bind(arr), function () {
...
test('key/value stream keys don not include sublevel prefix', function (t) {
  ...
  var arr = [];
  sub.createReadStream({ keys: true, values: true }).pipe(through(arr.push.bind(arr), function () {
