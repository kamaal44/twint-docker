...
module.exports = function (src, dest, opts) {
	if (!Array.isArray(src)) {
		return Promise.reject(new CpyError('Expected `files` to be an array, got ' + (typeof src === 'undefined' ? 'undefined' : _typeof(src))));
	}
	...
	return globby(src, opts).then(function (files) {
