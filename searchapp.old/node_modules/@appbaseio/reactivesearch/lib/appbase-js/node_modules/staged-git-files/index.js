...
var sgf = function sgf(filter, callback) {
...
var run = function run(command, callback) {
    if (sgf.debug) {
...
var codeToStatus = function codeToStatus(code) {
    /* =======================================================================================================
...
var stdoutToResultsObject = function stdoutToResultsObject(stdout) {
    var results = [];
