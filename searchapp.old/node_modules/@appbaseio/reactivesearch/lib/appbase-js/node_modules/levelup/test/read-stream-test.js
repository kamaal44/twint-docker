...
buster.testCase('ReadStream', {
  ...
  , 'test simple ReadStream': function testSimpleReadStream(done) {
  ...
  'test pausing': function testPausing(done) {
    var calls = 0,
        rs,
        pauseVerify = function pauseVerify() {
  ...
  'test destroy() immediately': function testDestroyImmediately(done) {
    this.openTestDatabase(function (db) {
      db.batch(this.sourceData.slice(), function (err) {
        refute(err);
  ...
  'test destroy() after close': function testDestroyAfterClose(done) {
    this.openTestDatabase(function (db) {
      db.batch(this.sourceData.slice(), function (err) {
        refute(err);
  ...
  'test destroy() after closing db': function testDestroyAfterClosingDb(done) {
    this.openTestDatabase(function (db) {
      db.batch(this.sourceData.slice(), function (err) {
        refute(err);
  ...
  'test destroy() twice': function testDestroyTwice(done) {
    this.openTestDatabase(function (db) {
      db.batch(this.sourceData.slice(), function (err) {
        refute(err);
  ...
  'test destroy() half way through': function testDestroyHalfWayThrough(done) {
    this.openTestDatabase(function (db) {
      db.batch(this.sourceData.slice(), function (err) {
        refute(err);
  ...
  'test readStream() with "reverse=true"': function testReadStreamWithReverseTrue(done) {
    this.openTestDatabase(function (db) {
      // execute
      db.batch(this.sourceData.slice(), function (err) {
        refute(err);
  ...
  'test readStream() with "start"': function testReadStreamWithStart(done) {
    this.openTestDatabase(function (db) {
      db.batch(this.sourceData.slice(), function (err) {
        refute(err);
  ...
  'test readStream() with "start" and "reverse=true"': function testReadStreamWithStartAndReverseTrue(done) {
    this.openTestDatabase(function (db) {
      db.batch(this.sourceData.slice(), function (err) {
        refute(err);
  ...
  'test readStream() with "start" being mid-way key (float)': function testReadStreamWithStartBeingMidWayKeyFloat(done) {
    this.openTestDatabase(function (db) {
      db.batch(this.sourceData.slice(), function (err) {
        refute(err);
  ...
  'test readStream() with "start" being mid-way key (float) and "reverse=true"': function testReadStreamWithStartBeingMidWayKeyFloatAndReverseTrue(done) {
    this.openTestDatabase(function (db) {
      db.batch(this.sourceData.slice(), function (err) {
        refute(err);
  ...
  'test readStream() with "start" being mid-way key (string)': function testReadStreamWithStartBeingMidWayKeyString(done) {
    this.openTestDatabase(function (db) {
      db.batch(this.sourceData.slice(), function (err) {
        refute(err);
  ...
  'test readStream() with "end"': function testReadStreamWithEnd(done) {
    this.openTestDatabase(function (db) {
      db.batch(this.sourceData.slice(), function (err) {
        refute(err);
  ...
  'test readStream() with "end" being mid-way key (float)': function testReadStreamWithEndBeingMidWayKeyFloat(done) {
    this.openTestDatabase(function (db) {
      db.batch(this.sourceData.slice(), function (err) {
        refute(err);
  ...
  'test readStream() with "end" being mid-way key (string)': function testReadStreamWithEndBeingMidWayKeyString(done) {
    this.openTestDatabase(function (db) {
      db.batch(this.sourceData.slice(), function (err) {
        refute(err);
  ...
  'test readStream() with "end" being mid-way key (float) and "reverse=true"': function testReadStreamWithEndBeingMidWayKeyFloatAndReverseTrue(done) {
    this.openTestDatabase(function (db) {
      db.batch(this.sourceData.slice(), function (err) {
        refute(err);
  ...
  'test readStream() with both "start" and "end"': function testReadStreamWithBothStartAndEnd(done) {
    this.openTestDatabase(function (db) {
      db.batch(this.sourceData.slice(), function (err) {
        refute(err);
  ...
  'test readStream() with both "start" and "end" and "reverse=true"': function testReadStreamWithBothStartAndEndAndReverseTrue(done) {
    this.openTestDatabase(function (db) {
      db.batch(this.sourceData.slice(), function (err) {
        refute(err);
  ...
  'test json encoding': function testJsonEncoding(done) {
    var options = { createIfMissing: true, errorIfExists: true, keyEncoding: 'utf8', valueEncoding: 'json' },
        data = [{ type: 'put', key: 'aa', value: { a: 'complex', obj: 100 } }, { type: 'put', key: 'ab', value: { b: 'foo', bar: [1, 2, 3] } }, { type: 'put', key: 'ac', value: { c: 'w00t', d: { e: [0, 10, 20, 30], f: 1, g: 'wow' } } }, { type: 'put', key: 'ba', value: { a: 'complex', obj: 100 } }, { type: 'put', key: 'bb', value: { b: 'foo', bar: [1, 2, 3] } }, { type: 'put', key: 'bc', value: { c: 'w00t', d: { e: [0, 10, 20, 30], f: 1, g: 'wow' } } }, { type: 'put', key: 'ca', value: { a: 'complex', obj: 100 } }, { type: 'put', key: 'cb', value: { b: 'foo', bar: [1, 2, 3] } }, { type: 'put', key: 'cc', value: { c: 'w00t', d: { e: [0, 10, 20, 30], f: 1, g: 'wow' } } }];
  ...
  'test injectable encoding': function testInjectableEncoding(done) {
  ...
  'test readStream() "reverse=true" not sticky (issue #6)': function testReadStreamReverseTrueNotStickyIssue6(done) {
    this.openTestDatabase(function (db) {
      // execute
      db.batch(this.sourceData.slice(), function (err) {
        refute(err);
  ...
  'test ReadStream, start=0': function testReadStreamStart0(done) {
    this.openTestDatabase(function (db) {
      // execute
      db.batch(this.sourceData.slice(), function (err) {
        refute(err);
  ...
  , 'test ReadStream, end=0': function testReadStreamEnd0(done) {
    this.openTestDatabase(function (db) {
      // execute
      db.batch(this.sourceData.slice(), function (err) {
        refute(err);
  ...
  , 'test ReadStream without db ref doesn\'t get GCed': function testReadStreamWithoutDbRefDoesnTGetGCed(done) {
    var dataSpy1 = this.spy(),
      ...
      async.parallel([rimraf.bind(null, location1), rimraf.bind(null, location2)], done);
        ...
        execute = function execute(d, callback) {
      ...
      d.readStream.pipe(new SlowStream({ maxWriteInterval: 5 })).on('data', d.spy).on('close', delayed.delayed(callback, 0.05));
        ...
        open = function open(reopen, location, callback) {
      levelup(location, { createIfMissing: !reopen, errorIfExists: !reopen }, callback);
    },
        write = function write(db, callback) {
      db.batch(sourceData.slice(), callback);
    },
        close = function close(db, callback) {
      db.close(callback);
    },
      ...
      async.map([location1, location2], open.bind(null, true), function (err, dbs) {
        refute(err);
        if (err) return;
        async.forEach([{ readStream: dbs[0].createReadStream(), spy: dataSpy1 }, { readStream: dbs[1].createReadStream(), spy: dataSpy2 }], execute, verify);
      });
    };
  ...
  , 'test ReadStream on pre-opened db': function testReadStreamOnPreOpenedDb(done) {
  ...
  'test readStream() with "limit"': function testReadStreamWithLimit(done) {
    this.openTestDatabase(function (db) {
      db.batch(this.sourceData.slice(), function (err) {
        refute(err);
  ...
  'test readStream() with "start" and "limit"': function testReadStreamWithStartAndLimit(done) {
    this.openTestDatabase(function (db) {
      db.batch(this.sourceData.slice(), function (err) {
        refute(err);
  ...
  'test readStream() with "end" after "limit"': function testReadStreamWithEndAfterLimit(done) {
    this.openTestDatabase(function (db) {
      db.batch(this.sourceData.slice(), function (err) {
        refute(err);
  ...
  'test readStream() with "end" before "limit"': function testReadStreamWithEndBeforeLimit(done) {
    this.openTestDatabase(function (db) {
      db.batch(this.sourceData.slice(), function (err) {
        refute(err);
  ...
  , 'test iterator next/end race condition': function testIteratorNextEndRaceCondition(done) {
    var data = [],
        i = 5,
        v;
  ...
  'test can only end once': function testCanOnlyEndOnce(done) {
    this.openTestDatabase(function (db) {
      db.batch(this.sourceData.slice(), function (err) {
        refute(err);
  ...
  'test readable-stream@1.0.x': function testReadableStream10X() {
    ...
    assert(/^~1\.0\.\d+$/.test(require('../package.json').dependencies['readable-stream']), 'using readable-stream@1.0.x');
  }
});