...
;(function (e) {
  function r(e, t) {
    if (s(e) !== "object") return t;for (var n in t) {
    ...
    var o = i[0],
        u = i.length;if (e || s(o) !== "object") o = {};for (var a = 0; a < u; ++a) {
      var f = i[a],
          l = s(f);if (l !== "object") continue;for (var c in f) {
        if (c === "__proto__") continue;var h = e ? t.clone(f[c]) : f[c];if (n) {
          o[c] = r(o[c], h);
        } else {
          o[c] = h;
        }
    ...
    return i(e === true, false, arguments);
      ...
      n = "merge";t.recursive = function (e) {
