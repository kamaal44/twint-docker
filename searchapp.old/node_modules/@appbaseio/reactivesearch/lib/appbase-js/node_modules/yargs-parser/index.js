...
function parse(args, opts) {
  ...
  var negatedBoolean = new RegExp('^--' + configuration['negation-prefix'] + '(.+)');[].concat(opts.array).filter(Boolean).forEach(function (key) {
    ...
    Object.keys(argv).forEach(function (key) {
      if (!applied.hasOwnProperty(key)) {
        ...
        if (typeof coerce === 'function') {
          try {
            var value = coerce(argv[key]);[].concat(flags.aliases[key] || [], key).forEach(function (ali) {
