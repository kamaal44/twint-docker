...
Rx.Node = {
   ...
   */
  fromCallback: function fromCallback(func, context, selector) {
   ...
   */
  fromNodeCallback: function fromNodeCallback(func, context, selector) {
   ...
   */
  fromEvent: function fromEvent(eventEmitter, eventName, selector) {
   ...
   */
  toEventEmitter: function toEventEmitter(observable, eventName, selector) {
   ...
   */
  fromStream: function fromStream(stream, finishEventName) {
    stream.pause();
   ...
   */
  fromReadableStream: function fromReadableStream(stream) {
   ...
   */
  fromWritableStream: function fromWritableStream(stream) {
   ...
   * @returns {Observable} An observable sequence which fires on each 'data' event as well as handling 'error' and 'finish' events.
   */
  fromTransformStream: function fromTransformStream(stream) {
    return this.fromStream(stream, 'finish');
  },
   ...
   */
  writeToStream: function writeToStream(observable, stream, encoding) {
