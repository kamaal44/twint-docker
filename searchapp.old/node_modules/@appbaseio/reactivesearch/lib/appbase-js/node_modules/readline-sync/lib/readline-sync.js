...
function isMatched(res, comps, caseSensitive) {
  return comps.some(function (comp) {
    var type = typeof comp === 'undefined' ? 'undefined' : _typeof(comp);
...
function array2charlist(array, caseSensitive, collectSymbols) {
  ...
  if (symbols) {
    values.push(symbols);suppressed = true;
  }
...
exports.questionNewPassword = function (query, options) {
  ...
  var resCharlist,
    ...
    phContent: function phContent(param) {
...
function getClHandler(commandHandler, options) {
  var clHandler = {},
      hIndex = {};
  if ((typeof commandHandler === 'undefined' ? 'undefined' : _typeof(commandHandler)) === 'object') {
...
function _setOption(optionName, args) {
  var options;
  if (args.length) {
    options = {};options[optionName] = args[0];
  }
