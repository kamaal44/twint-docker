...
module.exports = {
    'Verify Has Properties': function VerifyHasProperties(test) {
    ...
    'Verify Has Dashed Properties': function VerifyHasDashedProperties(test) {
        var style = new cssstyle.CSSStyleDeclaration();
    ...
    'Verify Has Functions': function VerifyHasFunctions(test) {
        var style = new cssstyle.CSSStyleDeclaration();
        test.expect(6);
    ...
    'Verify Has Special Properties': function VerifyHasSpecialProperties(test) {
        var style = new cssstyle.CSSStyleDeclaration();
        test.expect(5);
    ...
    'Test From Style String': function TestFromStyleString(test) {
        var style = new cssstyle.CSSStyleDeclaration();
        test.expect(8);
    ...
    'Test From Properties': function TestFromProperties(test) {
        var style = new cssstyle.CSSStyleDeclaration();
        test.expect(11);
        style.color = 'blue';
    ...
    'Test Shorthand Properties': function TestShorthandProperties(test) {
        var style = new cssstyle.CSSStyleDeclaration();
        test.expect(11);
    ...
    'Test width and height Properties and null and empty strings': function TestWidthAndHeightPropertiesAndNullAndEmptyStrings(test) {
        var style = new cssstyle.CSSStyleDeclaration();
        test.expect(9);
        style.height = 6;
    ...
    'Test Implicit Properties': function TestImplicitProperties(test) {
        var style = new cssstyle.CSSStyleDeclaration();
        test.expect(7);
        style.borderWidth = 0;
        test.ok(1 === style.length, 'length is not 1');
    ...
    'Test Top, Left, Right, Bottom Properties': function TestTopLeftRightBottomProperties(test) {
        var style = new cssstyle.CSSStyleDeclaration();
        test.expect(6);
        style.top = 0;
        style.left = '0%';
    ...
    'Test Clear and Clip Properties': function TestClearAndClipProperties(test) {
        var style = new cssstyle.CSSStyleDeclaration();
        test.expect(10);
        style.clear = 'none';
    ...
    'Test colors': function TestColors(test) {
        var style = new cssstyle.CSSStyleDeclaration();
        test.expect(4);
    ...
    'Test short hand properties with embedded spaces': function TestShortHandPropertiesWithEmbeddedSpaces(test) {
        var style = new cssstyle.CSSStyleDeclaration();
        test.expect(4);
    ...
    'Setting shorthand properties to an empty string should clear all dependent properties': function SettingShorthandPropertiesToAnEmptyStringShouldClearAllDependentProperties(test) {
        var style = new cssstyle.CSSStyleDeclaration();
        test.expect(2);
    ...
    'Setting implicit properties to an empty string should clear all dependent properties': function SettingImplicitPropertiesToAnEmptyStringShouldClearAllDependentProperties(test) {
        var style = new cssstyle.CSSStyleDeclaration();
        test.expect(2);
    ...
    'Setting a shorthand property, whose shorthands are implicit properties, to an empty string should clear all dependent properties': function SettingAShorthandPropertyWhoseShorthandsAreImplicitPropertiesToAnEmptyStringShouldClearAllDependentProperties(test) {
        var style = new cssstyle.CSSStyleDeclaration();
        test.expect(4);
        style.borderTopWidth = '1px';
        test.ok('border-top-width: 1px;' === style.cssText, 'cssText is not "border-top-width: 1px;": ' + style.cssText);
    ...
    'Setting border values to "none" should clear dependent values': function SettingBorderValuesToNoneShouldClearDependentValues(test) {
        var style = new cssstyle.CSSStyleDeclaration();
        test.expect(8);
        style.borderTopWidth = '1px';
        test.ok('border-top-width: 1px;' === style.cssText, 'cssText is not "border-top-width: 1px;": ' + style.cssText);
    ...
    'Setting border to 0 should be okay': function SettingBorderTo0ShouldBeOkay(test) {
        var style = new cssstyle.CSSStyleDeclaration();
        test.expect(1);
        style.border = 0;
    ...
    'Setting values implicit and shorthand properties via cssText and setProperty should propagate to dependent properties': function SettingValuesImplicitAndShorthandPropertiesViaCssTextAndSetPropertyShouldPropagateToDependentProperties(test) {
        var style = new cssstyle.CSSStyleDeclaration();
        test.expect(4);
    ...
    'Setting opacity should work': function SettingOpacityShouldWork(test) {
        var style = new cssstyle.CSSStyleDeclaration();
        test.expect(3);
    ...
    'Width and height of auto should work': function WidthAndHeightOfAutoShouldWork(test) {
        var style = new cssstyle.CSSStyleDeclaration();
        test.expect(4);
        style.width = "auto";
    ...
    'Padding and margin should set/clear shorthand properties': function PaddingAndMarginShouldSetClearShorthandProperties(test) {
        var style = new cssstyle.CSSStyleDeclaration();
        var parts = ["Top", "Right", "Bottom", "Left"];
        var testParts = function testParts(name, v, V) {
            style[name] = v;
            for (var i = 0; i < 4; i++) {
    ...
    'Padding and margin shorthands should set main properties': function PaddingAndMarginShorthandsShouldSetMainProperties(test) {
        var style = new cssstyle.CSSStyleDeclaration();
        var parts = ["Top", "Right", "Bottom", "Left"];
        var testParts = function testParts(name, v, V) {
            var expect;
    ...
    'Setting a value to 0 should return the string value': function SettingAValueTo0ShouldReturnTheStringValue(test) {
        var style = new cssstyle.CSSStyleDeclaration();
        test.expect(1);
    ...
    'onChange callback should be called when the cssText changes': function onChangeCallbackShouldBeCalledWhenTheCssTextChanges(test) {
    ...
    'Setting float should work the same as cssFloat': function SettingFloatShouldWorkTheSameAsCssFloat(test) {
        var style = new cssstyle.CSSStyleDeclaration();
        test.expect(1);
        style.float = 'left';
    ...
    'Setting improper css to cssText should not throw': function SettingImproperCssToCssTextShouldNotThrow(test) {
        var style = new cssstyle.CSSStyleDeclaration();
        test.expect(2);
        style.cssText = 'color: ';
    ...
    'Make sure url parsing works with quotes': function MakeSureUrlParsingWorksWithQuotes(test) {
        var style = new cssstyle.CSSStyleDeclaration();
        test.expect(3);
    ...
    'Make sure setting 0 to a padding or margin works': function MakeSureSetting0ToAPaddingOrMarginWorks(test) {
        var style = new cssstyle.CSSStyleDeclaration();
        test.expect(2);
        style.padding = 0;
    ...
    'Make sure setting ex units to a padding or margin works': function MakeSureSettingExUnitsToAPaddingOrMarginWorks(test) {
        var style = new cssstyle.CSSStyleDeclaration();
        test.expect(2);
        style.padding = '1ex';
    ...
    'Make sure setting null to background works': function MakeSureSettingNullToBackgroundWorks(test) {
        var style = new cssstyle.CSSStyleDeclaration();
        test.expect(2);
    ...
    'Flex properties should keep their values': function FlexPropertiesShouldKeepTheirValues(test) {
        var style = new cssstyle.CSSStyleDeclaration();
        test.expect(2);
    ...
    'Make sure camelCase properties are not assigned with `.setProperty()`': function MakeSureCamelCasePropertiesAreNotAssignedWithSetProperty(test) {
        var style = new cssstyle.CSSStyleDeclaration();
        test.expect(1);
    ...
    'Make sure casing is ignored in `.setProperty()`': function MakeSureCasingIsIgnoredInSetProperty(test) {
        var style = new cssstyle.CSSStyleDeclaration();
        test.expect(2);
    ...
    'Support non string entries in border-spacing': function SupportNonStringEntriesInBorderSpacing(test) {
        var style = new cssstyle.CSSStyleDeclaration();
        test.expect(1);
