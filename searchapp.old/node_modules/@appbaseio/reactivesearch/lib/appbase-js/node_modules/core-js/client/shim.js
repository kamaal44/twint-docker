...
!function (__e, __g, undefined) {
  ...
  /***/function (module, exports, __webpack_require__) {
    ...
    // @@split logic
    __webpack_require__(59)('split', 2, function (defined, SPLIT, _$split2) {
      if ('abbc'[$SPLIT](/(b)*/)[1] == 'c' || 'test'[$SPLIT](/(?:)/, -1)[LENGTH] != 4 || 'ab'[$SPLIT](/(?:ab)*/)[LENGTH] != 2 || '.'[$SPLIT](/(.?)(.?)/)[LENGTH] != 4 || '.'[$SPLIT](/()()/)[LENGTH] > 1 || ''[$SPLIT](/.?/)[LENGTH]) {
        var NPCG = /()??/.exec('')[1] === undefined; // nonparticipating capturing group
        // based on es5-shim implementation, need to rework it
        _$split2 = function $split(separator, limit) {
          var string = String(this);
          if (separator === undefined && limit === 0) return [];
          // If `separator` is not a regex, use native split
          if (!isRegExp(separator)) return _$split2.call(string, separator, limit);
          var output = [];
        ...
        _$split2 = function _$split(separator, limit) {
          return separator === undefined && limit === 0 ? [] : _$split2.call(this, separator, limit);
        };
      }
      ...
      function split(separator, limit) {
        ...
        return splitter !== undefined ? splitter.call(separator, O, limit) : _$split2.call(String(O), separator, limit);
      },
      ...
      function (regexp, limit) {
        ...
        if (regexp.exec === nativeExec) return _$split2.call(this, regexp, limit);
